<div class="flex justify-center my-20">
	<div class="justify-start space-y-8 max-w-4xl">
		...
		<p class="text-xl md:text-2xl">
			If you are a Curator please log in with the Pure Proxy Curator Address to access the curator
			functionalities.
		</p>
		<p class="text-xl md:text-2xl">
			Currently using Multix through WalletConnect is the only supported method. Support for Mimir
