		...
		<div class="content">
			<div>
				<div>
					...
					<input
						class="border border-border w-1/2 pt-1 pl-2 rounded-md bg-white mr-2"
						placeholder="5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty"
					/>
					<p class="text-xs my-1">Curator Fee</p>
					<input class="border border-border pt-1 pl-2 rounded-md bg-white mr-2 w-1/3" placeholder="100.0000" />
