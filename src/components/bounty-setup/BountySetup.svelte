...
>
	<div class="container setup-container max-w-screen-lg rounded-md p-4 space-y-4">
		<h2 class="font-bold text-lg sm:text-2xl text-white text-center">Bounty Setup</h2>
		<div class="border border-accent rounded-md overflow-clip">
			<div class="flex relative h-20 px-2 md:px-8 bg-primary rounded-md">
