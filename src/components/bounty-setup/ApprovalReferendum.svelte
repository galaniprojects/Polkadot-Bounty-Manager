	...
	{#if success}
		<div class="bg-backgroundContent p-3 md:px-6 w-full box-border overflow-x-hidden">
			<p class="w-full md:w-2/3">
				...
				<br /><br />
				Please update the description on one of the social platforms like
				<a href="/bs" class="link underline underline-offset-2">Polkassembly</a> or Subsquare. The
				decision deposit must be placed within 7 days, for the referendum to be valid. (This deposit
				can be placed by any account). This can be submitted either on one of the social platforms
				or via the polkadot.js explorer.
				<br /> <br />
