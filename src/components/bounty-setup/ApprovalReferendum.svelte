	...
	<div class="content">
		<div>
			<div>
				...
				<select class="border w-72 rounded-md h-7 px-1" name="spenders" id="spenders">
			...
			<select class="border w-72 rounded-md h-7 px-1" name="accounts" id="accounts">
		...
		<div class="flex">
			...
			<button class="button-active">SUBMIT</button>
		</div>
	</div>
</div>