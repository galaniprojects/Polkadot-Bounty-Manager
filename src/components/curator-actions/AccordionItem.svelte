					...
					<div class="bounty-button-container">
						...
						<div class="space-x-2">
							<button
								...
								class="bounty-button">AWARD</button
							>
							<button class="pt-1 w-5 h-5"><InfoSvg /></button>
						</div>
					</div>
...
<style>
	...
	.bounty-button-container {
		@apply flex lg:flex-col xl:flex-row xl:space-x-3 lg:space-y-2 items-end text-sm xl:mr-4 lg:mr-7;
	}
</style>
