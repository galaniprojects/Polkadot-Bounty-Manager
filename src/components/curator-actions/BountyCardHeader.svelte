...
<div class="text-textPrimary max-h-fit p-5 lg:px-10 w-full">
	<div class="flex justify-between">
		...
		<button
			...
			class="material-symbols-outlined text-textPrimary text-3xl self-start pt-3"
		>
			{#if isParentExpanded}
				keyboard_arrow_up
			{:else}
...
<div
	class="flex flex-col lg:flex-row lg:justify-start text-xs lg:mt-0 items-baseline pl-10 bg-backgroundChildBountyDetails text-textPrimary"
>
